                                                            ...
                                                            <form action="updatecustomerdata" onsubmit="return checkprofiledata()" name="updatecusdata"   method="POST"  class="form-horizontal">
                                                                <div class="form-body">
                                                                    <div class="form-group form-md-line-input">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <input type="text" id="fname" name="fname" value="<%=c.getDeveloperFname()%>" required class="form-control" placeholder="" required>
                                                                            <div class="form-control-focus"> </div>
                                                                    ...
                                                                    <div class="form-group form-md-line-input">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <input type="text" id="mname" value="<%=c.getDeveloperMname()%>" name="mname"  class="form-control" placeholder="">
                                                                            <div class="form-control-focus"> </div>
                                                                    ...
                                                                    <div class="form-group form-md-line-input">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <input type="text" name="lname" value="<%=c.getDeveloperLname()%>" id="lname" class="form-control" placeholder="" required>
                                                                            <div class="form-control-focus"> </div>
                                                                    ...
                                                                    <div class="form-group form-md-line-input">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                         ...
                                                                         <div class="form-group form-md-line-input">
                                                                        <label class="col-md-3 control-label" for="form_control_1">Account No</label>
                                                                        <div class="col-md-6">
                                                                            <input type="text" name="address"value="<%=c.getDevelopercreditcartNo()%>" id="address" class="form-control" placeholder="" required>
                                                                            <div class="form-control-focus"> </div>

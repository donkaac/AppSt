<%-- 
    Document   : system_500
    Created on : Sep 18, 2016, 8:59:43 PM
    Author     : Achi
--%>
...
<![endif]-->
        ...
        <script src="./assets/pages/scripts/system500.js" type="text/javascript"></script>
        <script>
            var path = 'system_500.jsp'; //write here name of your page 

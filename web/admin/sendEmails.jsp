                    ...
                    <div class="page-content">
                        ...
                        <div class="page-container" id="applicationArea">
                            <form action="sendmails" onsubmit="return checksendingmail()">
                                ...
                                <input id="hedder" class="form-control input-md" type="text" name="hedder" placeholder="Pleace Enter Mail Header"/>
                                
                                <div class="c-contact">

                                    <div class="form-group">
                                        <textarea id="message" rows="8" name="message" placeholder="Write Message here ..." class="form-control input-md"></textarea>
                                    </div>
...
<script src="../validation/sendmailvalidation.js" type="text/javascript"></script>

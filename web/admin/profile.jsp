                                                            ...
                                                            <form action="../updatestafffdata" onsubmit="return checkprofiledata()" name="updatecusdata"   method="POST"  class="form-horizontal">
                                                                <div class="form-body">
                                                                    <div class="form-group form-md-line-input">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <input type="text" id="fname" name="fname" value="<%=c.getStaffFname()%>" required class="form-control" placeholder="" required>
                                                                            <div class="form-control-focus"> </div>
                                                                    ...
                                                                    <div class="form-group form-md-line-input">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <input type="text" id="mname" value="<%=c.getStaffMname()%>" name="mname"  class="form-control" placeholder="">
                                                                            <div class="form-control-focus"> </div>
                                                                    ...
                                                                    <div class="form-group form-md-line-input">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <input type="text" name="lname" value="<%=c.getStaffLname()%>" id="lname" class="form-control" placeholder="" required>
                                                                            <div class="form-control-focus"> </div>

                                        ...
                                        <tbody>
                                            ...
                                            <tr id="data">
                                                <td class="col-sm-8 col-md-6">
                                                    <div class="media">
                                                        <a class="thumbnail pull-left" href="viewapp.jsp?appid=<%=cart.getApplication().getIdApplication()%>"> <img class="media-object" src="<%=cart.getApplication().getAppImage()%>" style="width: 72px; height: 72px;"> </a>

<%-- 
    Document   : staffRoles
    Created on : Oct 16, 2016, 12:47:39 PM
    Author     : Ish
--%>
...
<!DOCTYPE html><%
     ...
     boolean states=false;
      for(Rolehassubmenu rhs:list){
        if(  rhs.getSubmenu().getPageurl()=="staffRoles.jsp"){
            ...
            <div class="page-container">
                ...
                <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 class="page-header">Developer Validation Details </h1>
                            </div>
                        </div>
                        <%-- Main--%> 
                        <style type="text/css">
                        ...
                        <div class="container">
                            ...
                            <div class="scrollit">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <%
                                            ArrayList<Object> develist = Datacontroller.DataParser.Searchdata(new Developer());
                                            for (Object cob : develist) {
                                                Developer c = (Developer) cob;
                                                if (c.isState()&(c.getDevelopervalids().size()==0)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><%=c.getDevelopercreditcartNo()%></td>
                                            <td><%=c.getDeveloperMobile()%></td>
                                            <td><%=c.getDeveloperPhone()%></td>
                                            <td><%= c.getDeveloperRegdate()%></td>
                                            <form action="../setdevelopervalid" method="POST">
                                           
                                            <td><input type="hidden" name="developerid" value="<%=c.getIdDeveloper()%>"/><a class="btn-default"><button type="submit"><span class="glyphicon glyphicon-chevron-down">Set Valid Developer </span></button></a></td></form>
                                        </tr>
                                        <%}
                                        }%>
                                    </tbody>

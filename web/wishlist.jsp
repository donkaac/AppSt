<%-- 
    Document   : wishlist
    Created on : Sep 16, 2016, 5:32:07 PM
    Author     : Ish
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <!-- general -->
        <div class="general">
            <h4 class="latest-text w3_latest_text">Cart Apps Items List</h4>
            <div class="container">
                        ...
                        <div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
                            ...
                            <div class="w3_agile_featured_movies">
                                <%
                                    double total=0;
                                    try{
                                   ArrayList<Object> Searchdata= Datacontroller.DataParser.Searchdata(new Wishlist());        
                                    for(Object o:Searchdata) {
                                Wishlist wishlist=(Wishlist)o;
                                 if(!wishlist.getCustomer().getUsername().equals(session.getAttribute("username"))){
                                     total=+wishlist.getApplication().getPrice();
                                ...
                                <div class="col-md-2 w3l-movie-gride-agile">
                                    ...
                                    <div class="mid-1 agileits_w3layouts_mid_1_home">
                                        <div class="w3l-movie-text">
                                            <h6><a href="single.html"><%=wishlist.getApplication().getApplicationName()%></a></h6>							
                                        </div>
